      ...
      {!coverLetter && !generating && (
        <div className="flex flex-col items-center justify-center py-24 text-center space-y-8 bg-white border-2 border-dashed border-[#e2e2d9] mx-4 tactile-pop">
          ...
          <div className="space-y-3 px-8">
            ...
            <p className="text-[13px] text-[#666] max-w-[300px] leading-relaxed mx-auto font-medium font-sans">Generate a tailored cover letter structured for maximum impact.</p>
          </div>
      ...
      {generating && (
        <div className="flex flex-col items-center justify-center py-32 text-center space-y-10 animate-in fade-in duration-700">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-[#666] font-mono uppercase tracking-[4px] font-bold">Matching skills and aligning objectives</p>
          </div>
        </div>
      )}
      ...
      {coverLetter && !generating && (
        <div className="space-y-10">
          <div className="flex items-center justify-between px-2">
            <h4 className="text-[11px] font-mono font-semibold text-[#666] tracking-[1px]">Draft Content</h4>
          ...
          {job.status === 'interviewing' && job.cover_letter_id && (
            <div className="p-10 bg-[#f0f0eb] border border-[#e2e2d9] space-y-8 tactile-pop relative overflow-hidden">
              <h4 className="text-[11px] font-mono font-semibold text-[#666] tracking-[1px] text-center relative z-10">Outcome Tracking</h4>
              <div className="flex gap-4 relative z-10">
                {[
                  ...
                  { value: 'no_response', label: 'Neutral', color: 'text-[#666]', bg: 'bg-white', border: 'border-[#e2e2d9]' },
                ].map(opt => (
