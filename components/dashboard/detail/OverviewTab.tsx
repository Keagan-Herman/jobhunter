    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-forwards">
      ...
      {job.score_reason && (
        <div className="p-12 bg-[#f5f0e8] border border-[#e2e2d9] border-t-2 border-t-[#c5a059] space-y-8 relative overflow-hidden tactile-pop">
          ...
          <div className="pt-6 flex items-center gap-4 relative z-10">
              ...
              <span className="text-[9px] font-mono font-bold text-[#666] uppercase tracking-[4px]">System Verified</span>
          </div>
        </div>
      )}

      <div className="space-y-4">
        <h4 className="font-syne font-bold text-[15px] text-[#1a1a1a] tracking-tight">Specification</h4>
      ...
      {job.interview_prep && (
        <div className="space-y-4 pb-12">
          <h4 className="font-syne font-bold text-[15px] text-[#1a1a1a] tracking-tight">Interview Strategy</h4>
