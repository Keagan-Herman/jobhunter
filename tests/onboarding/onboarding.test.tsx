...
describe('OnboardingPage', () => {
  ...
  it('renders step 1 by default', async () => {
    ...
    expect(screen.getByText(/Ready to land your next role/i)).toBeInTheDocument()
  })
  ...
  it('navigates through steps manually', async () => {
    ...
    expect(screen.getByRole('heading', { name: /Your Professional Profile/i })).toBeInTheDocument()
